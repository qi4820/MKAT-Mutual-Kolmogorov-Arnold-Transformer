...
from layers.Transformer_EncDec import Decoder, DecoderLayer, Encoder, EncoderLayer,KATEncoderLayer,KATEncoder
...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        enc_out, attns = self.encoder(enc_out, attn_mask=None, tau=tau, delta=delta,global_shared_denominator = self.shared_denominator)
